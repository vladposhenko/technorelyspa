...
import {getAllUsers, getOneUserThunk, setCurrentUser} from "../../redux/admin-reducer";
                        ...
                        <Card
                            ...
                            <div className="d-flex flex-column gap-3 pb-4 pt-4">
                                   <img className="m-auto" width='50' src="https://cdn-icons-png.flaticon.com/512/21/21104.png" alt=""/>
                                    ...
                                    <Button onClick={() => handleUserClick(user)} style={{width: '50%', margin:'0 auto'}} variant="outline-secondary">Детальнее</Button>
                            </div>
                        </Card>
                    ))}
                </ListGroup>
